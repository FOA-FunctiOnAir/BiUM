...
public partial class BaseRepository : IBaseRepository
{
    ...
    public virtual Task<ResponseMeta> AddMessage(
        ResponseMeta meta,
        string code,
        CancellationToken cancellationToken)
    {
        return _translationService.AddMessage(meta, code, string.Empty, MessageSeverity.Error, cancellationToken);
    }
    ...
    public virtual Task<ResponseMeta> AddMessage(
        ...
        CancellationToken cancellationToken)
    {
        return _translationService.AddMessage(meta, code, string.Empty, severity, cancellationToken);
    }
    ...
    public virtual Task<ResponseMeta> AddMessage(
        ...
        CancellationToken cancellationToken)
    {
        return _translationService.AddMessage(meta, code, exception.GetFullMessage(), MessageSeverity.Error, cancellationToken);
    }
    ...
    public virtual Task<ResponseMeta> AddMessage(
        ...
        CancellationToken cancellationToken)
    {
        return _translationService.AddMessage(meta, code, exception, severity, cancellationToken);
    }
