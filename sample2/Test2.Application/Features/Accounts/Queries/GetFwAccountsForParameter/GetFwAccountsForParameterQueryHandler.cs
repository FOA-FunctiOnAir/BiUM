...
public class GetFwAccountsForParameterQueryHandler : IPaginatedForValuesQueryHandler<GetFwAccountsForParameterQuery, GetFwAccountsForParameterDto>
{
    ...
    {
        var repositoryResponse = await _currencyRepository.GetFwAccountsForParameter(query.SelectedIds, query.ExcludedIds, query.Q, query.PageStart, query.PageSize, cancellationToken);
