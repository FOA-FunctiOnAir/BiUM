...
- **`BiUM.Contract`**: Shared resources.
    - `Models/Api/`: `ApiResponse`, `ApiResponseRollbackException` (internal rollback signal for failed `ApiResponse` in request transactions).
