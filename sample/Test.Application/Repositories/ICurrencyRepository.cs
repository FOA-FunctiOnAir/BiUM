...
public interface ICurrencyRepository
{
    ...
    Task<PaginatedApiResponse<GetFwCurrenciesForParameterDto>> GetFwCurrenciesForParameter(IReadOnlyList<Guid>? selectedIds, IReadOnlyList<Guid>? excludedIds, string? q, int? pageStart, int? pageSize, CancellationToken cancellationToken);
