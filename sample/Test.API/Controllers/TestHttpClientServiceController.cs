...
public class TestHttpClientServiceController : ApiControllerBase
{
    ...
    {
        var languages = await _httpClientsService.CallService<object>(
            serviceId: Guid.Parse("2fdfbfaa-ca10-5142-9af4-112244eea8b4"),
    ...
    {
        var assetGroups = await _httpClientsService.CallService<object>(
            serviceId: Guid.Parse("63f1b159-19ba-43e0-b74d-5cb80281ab3e"),
            cancellationToken: cancellationToken);
