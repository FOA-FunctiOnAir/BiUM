...
public class GetFwCurrenciesForParameterQueryHandler : IPaginatedForValuesQueryHandler<GetFwCurrenciesForParameterQuery, GetFwCurrenciesForParameterDto>
{
    ...
    {
        var repositoryResponse = await _currencyRepository.GetFwCurrenciesForParameter(query.SelectedIds, query.ExcludedIds, query.Q, query.PageStart, query.PageSize, cancellationToken);
