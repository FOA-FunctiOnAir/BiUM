...
public interface IAccountRepository
{
    ...
    Task<PaginatedApiResponse<GetFwAccountsForParameterDto>> GetFwAccountsForParameter(IReadOnlyList<Guid>? selectedIds, IReadOnlyList<Guid>? excludedIds, string? q, int? pageStart, int? pageSize, CancellationToken cancellationToken);
